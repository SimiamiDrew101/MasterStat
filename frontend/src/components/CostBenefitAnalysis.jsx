        ...
        <svg ref={svgRef} width={width} height={height} className="mx-auto">
          <g transform={`translate(${margin.left}, ${margin.top})`}>
            ...
            <text
              ...
              textAnchor="middle"
            >
              Cost per participant: ${optimal_design.cost_per_participant}
            </text>
          </g>
        </svg>
      </div>
        ...
        <div className="mt-4 bg-blue-900/20 rounded-lg p-4 border border-blue-700/30">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h5 className="text-blue-200 font-semibold mb-2 text-sm">Recommendations</h5>
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-slate-700/30 rounded-lg p-4">
          ...
          <p className="text-gray-400 text-xs leading-relaxed">
            The curve shows how total study cost increases as you target higher power levels.
            Notice the diminishing returns: going from 80% to 90% power costs more than from 50% to 80%.
          </p>
        </div>
        ...
        <div className="bg-slate-700/30 rounded-lg p-4">
          ...
          <p className="text-gray-400 text-xs leading-relaxed">
            The <span className="text-blue-400 font-semibold">blue dot</span> shows your optimal design given constraints.
            The <span className="text-green-400 font-semibold">green dot</span> shows the most cost-efficient design (best power per dollar).
            Hover over the curve to explore different trade-offs.
          </p>
        </div>
      </div>
    </div>
